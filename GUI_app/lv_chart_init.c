...
bool switch_state = true; // 初始状态为 ON
...
void main_test(void)
{
    ...
    lv_scr_load(main_screen);
		...
		image = lv_img_create(main_screen, NULL);
    lv_img_set_src(image, &ui_img_ecg_jpg); 
    lv_obj_align(image, NULL, LV_ALIGN_CENTER, 0, -60); // 调整图片位置
    // 创建“Welcome to ECG！”文本
    welcome_label = lv_label_create(main_screen, NULL);
    lv_label_set_text_static(welcome_label, "Welcome to ECG!");
    lv_obj_align(welcome_label, NULL, LV_ALIGN_CENTER, 0, -10);

    // 创建“Start”按钮
    start_btn = lv_btn_create(main_screen, NULL);
    lv_obj_set_size(start_btn, 80, 40);
    lv_obj_align(start_btn, NULL, LV_ALIGN_CENTER, 0, 30);

    // 创建按钮上的标签
    lv_obj_t * start_label = lv_label_create(start_btn, NULL);
    lv_label_set_text_static(start_label, "Start");

    // 设置按钮的事件回调函数
    lv_obj_set_event_cb(start_btn, start_event_handler);
...
void lv_chart_init(void)
{
    ...
    lv_obj_set_height(ui_Top_Content, 30);
    lv_obj_set_width(ui_Top_Content, 320);
    ...
    lv_obj_set_size(menu_btn,80,25);//设置大小
    ...
    lv_obj_align(menu_btn,ui_Top_Content,LV_ALIGN_IN_TOP_LEFT,5,2.5);
    ...
    lv_obj_set_size(back_btn,80,25);//设置大小
    ...
    lv_obj_align(back_btn,ui_Top_Content,LV_ALIGN_IN_TOP_RIGHT,5,2.5);
...
//    lv_style_set_text_font(&TEMPNum_style, LV_STATE_DEFAULT, &ui_font_Big_Number);
    ...
    lv_obj_align(ui_Number_TEMP,ui_Panel_Content,LV_ALIGN_IN_TOP_MID,100,25);
...
//    lv_style_set_text_font(&QRSNum_style, LV_STATE_DEFAULT, &ui_font_Big_Number);
    ...
    lv_obj_align(ui_Number_QRS,ui_Panel_Content, LV_ALIGN_IN_TOP_MID,100,70);
...
//    lv_style_set_text_font(&HRNum_style, LV_STATE_DEFAULT, &ui_font_Big_Number);
    ...
    lv_obj_align(ui_Number_HR,ui_Panel_Content, LV_ALIGN_IN_TOP_MID,100,115);
    ...
    lv_obj_align(ui_Label_TEMP, ui_Panel_Content,LV_ALIGN_IN_TOP_MID,140,10);
    lv_label_set_text(ui_Label_TEMP, "TEMP");
    // ui_Label_Centigrade
    ui_Label_Centigrade = lv_label_create(ui_Panel_Content,NULL);
    lv_obj_align(ui_Label_Centigrade,ui_Panel_Content, LV_ALIGN_IN_TOP_MID,140,30);
    ...
    lv_obj_align(ui_Label_QRS,ui_Panel_Content, LV_ALIGN_IN_TOP_MID,140,60);
    lv_label_set_text(ui_Label_QRS, "QRS");
    // ui_Label_Width
    ui_Label_Width = lv_label_create(ui_Panel_Content,NULL);
    lv_obj_align(ui_Label_Width,ui_Panel_Content, LV_ALIGN_IN_TOP_MID,140,80);
    ...
    lv_obj_align(ui_Label_HR,ui_Panel_Content ,LV_ALIGN_IN_TOP_MID,140,110);
    ...
    lv_obj_align(ui_IMG_Heart, ui_Panel_Content,LV_ALIGN_IN_TOP_MID,140,130);
	
	
    chart1 = lv_chart_create(ui_Panel_Content,NULL);
    lv_obj_set_size(chart1,240,200);//设置图表的大小
    ...
    lv_obj_align(ui_IMG_BTN_Bg, ui_Panel_Content,LV_ALIGN_IN_TOP_MID,120,155);
